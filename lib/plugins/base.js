...
function cleanTitleWebScrobbler (title) {
  return title.trim()
    ...
    .replace(/\s*\.(avi|wmv|mpg|mpeg|flv|mov)$/i, '') // video extensions
...
exports.splitArtistTitle = splitArtistTitle
exports.cleanTitle = cleanTitleWebScrobbler
exports.cleanArtist = cleanArtistWebScrobbler
